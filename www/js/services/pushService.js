angular.module('PushModule', ['starter.controllers.utils', 'storageModule'])

.service('pushService', function( $q, $cordovaDialogs,$cordovaPushV5, $localStorage, constants,  convenience) {
